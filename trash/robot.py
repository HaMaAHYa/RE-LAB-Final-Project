...
# =====================================================================
# 6.  IK SOLVER  (Damped Least Squares)
# =====================================================================
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if len(tokens) in (6, 7):
            ...
            B = np.array([0.64106, 0.0, 0.71507])
            ...
            for p in points:
                print(np.round(p, 5))
            '''
            [ 0.64106 -0.01111  0.69285]
[ 0.64106 -0.02222  0.67063]
[ 0.64106 -0.03333  0.6484 ]
[ 0.64106 -0.04444  0.62618]
[ 0.64106 -0.05556  0.60396]
[ 0.64106 -0.06667  0.58174]
[ 0.64106 -0.07778  0.55951]
[ 0.64106 -0.08889  0.53729]
[ 0.64106 -0.1      0.51507]
            '''
